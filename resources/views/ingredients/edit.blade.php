...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">Update an ingredient</div>
                <div class="card-body">
                    <form action="{{ route('ingredients.update', ['ingredient' => $ingredient->id]) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="The name of the ingredient" value="{{$ingredient->name}}">
                        </div>
                        <div class="col-sm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="enumber" name="enumber" placeholder="Ingredients E-Number" value="{{$ingredient->enumber}}">
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="allergen" name="allergen" {{ $ingredient->allergen ? 'checked' : '' }}>
